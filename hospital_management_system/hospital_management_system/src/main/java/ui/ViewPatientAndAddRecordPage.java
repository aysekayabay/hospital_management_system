...
public class ViewPatientAndAddRecordPage {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewPatientAndAddRecordPage window = new ViewPatientAndAddRecordPage();
	 ...
	 */
	public ViewPatientAndAddRecordPage() {
		initialize();
	}
	...
	private void initialize() {
		...
		JLabel view_patient_identity_number_output_label = new JLabel("");
		...
		JLabel view_patient_email_output_label = new JLabel("");
